        ...
        <div class="p-question__wrap">
          <div class="p-question__block">
            ...
            <div class="p-question__answer-wrapper">
              ...
              <br>
              工学部出身のため、入社後は希望していた設計部で製図を担当しましたが、当時の営業部の上司に「人と話すことが好きなら営業をやってみないか」と声をかけられ、<span class="u-font-outfit">2</span>年目に営業職へ。実際にやってみると思っていた以上に性に合っていて。今となっては「あの時、営業に転向してよかった！」と思っています。</p>
            </div>
          </div>
        ...
        <div class="p-question__row-wrapper">
          ...
          <div class="p-question__row ImgLeft">
            <div class="p-question__block">
              ...
              <div class="p-question__answer-wrapper">
                <p class="p-question__answer">某製薬会社様との共同開発プロジェクトです。今までにないモノを一緒に創ろうと共に悩み、トライ&エラーを繰り返して<span class="u-font-outfit">5</span>年の歳月を経て完成させました。あの時の達成感と感動は今も忘れられない思い出です。<br>
                <br>
