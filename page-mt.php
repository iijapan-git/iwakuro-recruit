        ...
        <div class="p-question__wrap">
          <div class="p-question__block">
            ...
            <div class="p-question__answer-wrapper">
              <p class="p-question__answer">元々は機械設計業務を担当していましたが、<span class="u-font-outfit">7</span>年前に制御設計に移動し、現在は主にサーボモータの制御設計を担当しています。制御設計は機械を動かすための電気回路をプログラミングする仕事で、なかでもサーボモータは高精度な動きを指示通りに動かすための重要なパーツ。岩黒製作所はこのサーボモータの設計を自社で行っているため、お客さまのご要望に寄り添ったより高精度な機械を開発することができます。</p>
            </div>
          </div>
        </div>
