        ...
        <div class="p-question__wrap">
          <div class="p-question__block">
            ...
            <div class="p-question__answer-wrapper">
              <p class="p-question__answer">高校時代に物理が得意だったことから「機械をつくる仕事がしたい」と思うようになりました。前職では研削盤を使った部品加工に携わっていましたが、<span class="u-font-outfit">30</span>代になり「新しいことに挑戦するなら今が最後のチャンスかもしれない」と転職を決意。転職会社を通じて岩黒製作所を知り、自社で機械を一から作っている点に惹かれて入社を決めました。</p>
            </div>
          </div>
        ...
        <div class="p-question__wrap">
          <div class="p-question__block">
            ...
            <div class="p-question__answer-wrapper">
              ...
              <br>
              機械加工というと、機械を操作するイメージが強いかもしれませんが、実際には図面の読み取り、プログラムの作成、数値の確認など、“頭を使う”仕事も多く、図面が複雑な場合はソフトを利用してプログラムを組むこともあります。簡単な加工だと数十分～<span class="u-font-outfit">1</span>時間程度ですが、複雑なものは加工に何十時間もかかることも。それだけに、複雑なものほど完成した時の達成感は大きいです。</p>
            </div>
          </div>
        </div>
