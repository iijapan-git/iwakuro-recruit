      ...
      <div class="p-question__content">
        <div class="p-question__wrap">
          <div class="p-question__block">
            ...
            <div class="p-question__answer-wrapper">
              ...
              営業職ではありませんが、お客さまと直接関わったり、他部署と連携して調整を行ったりすることも多い仕事です。経験を積むと<span class="u-font-outfit">1</span>台の機械を任される担当者になりますが、今はまだ先輩のサポートとして、知識と技術を学んでいます。</p>
            </div>
          </div>
        </div>
        ...
        <div class="p-question__wrap">
          <div class="p-question__block">
            ...
            <div class="p-question__answer-wrapper">
              <p class="p-question__answer">入社当初は図面を見ても作業内容が理解できませんでしたが、経験を積むうちに「この部品はここに付くだろう」と見当がつくように。作業がスムーズに進められるようになり、モノづくりのおもしろさを感じています。今の目標は、小規模な機械からでいいので、<span class="u-font-outfit">1</span>台を任せてもらえるようになることです。<br>
              <br>
              最もやりがいを感じたのは、主力機械である「PTP自動包装ライン」を納めた時です。この時は登録する薬の品目数が非常に多く、組付けや調整に長い時間がかかりました。さらに、納品後もお客さまのところに <span class="u-font-outfit">3</span>か月間通って調整を行ったため、完了した時の達成感は大きかったですね。</p>
            </div>
          </div>
