      ...
      <div class="p-question__content">
        ...
        <div class="p-question__wrap">
          <div class="p-question__block">
            ...
            <div class="p-question__answer-wrapper">
              <p class="p-question__answer">学ぶことや覚えることが多く機械設計の難しさを痛感しています。過去の問題点や改善点を踏まえつつお客さまのご要望に応える設計を考えること。そこには納期やコストといった制約も含まれるため、どうカタチにしていくか様々な課題をクリアしなければいけない難しさとやりがいがあります。異動後<span class="u-font-outfit">1</span>年目は先輩のサポート業務が主でしたが、<span class="u-font-outfit">2</span>年目の今、ようやく本格的に機械設計を任せてもらえるようになり機械づくりへの手応えを感じています。<br>
              <br>
          ...
          <div class="p-question__row ImgLeft">
            <div class="p-question__block">
              ...
              <div class="p-question__answer-wrapper">
                ...
                <br>
                福利厚生の手厚さも安心して働ける点ですね。夏冬のボーナスに加えて決算賞与も<span class="u-font-outfit">15</span>年連続で支給されているというのも嬉しいです。他にも様々な手当や費用サポートがあり、働き続けたいと思える会社です。これからも、成長を積み重ねていけるよう精進していきたいと思います。</p>
              </div>
            </div>
            <figure class="p-question__rowImg">
